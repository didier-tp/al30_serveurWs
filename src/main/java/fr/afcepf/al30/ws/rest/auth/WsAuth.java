package fr.afcepf.al30.ws.rest.auth;
...
import fr.afcepf.al30.ws.rest.auth.data.AuthResponse;
import fr.afcepf.al30.ws.rest.auth.data.Credential;

@RestController
@RequestMapping(value="/rest/auth" ,headers="Accept=application/json" )
public class WsAuth {
	
	//url = http://localhost:8080/serveurWs/mvc/rest/auth/verifAuth
